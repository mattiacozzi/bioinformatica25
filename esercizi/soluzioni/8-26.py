#Traccia:
#Aggiorna il file dei vincitori dell’Oscar come miglior attore come indicato nell’esercizio precedente e salva il tutto in un nuovo file chiamato “best-actor-age-updated.csv”.
import pandas as pd
...
#salvo in CSV
final.to_csv("best-actor-age-updated.csv")