#Traccia:
#Completa i dati contenuti in “best-actor-age.csv” con le informazioni relative ai vincitori dell’Oscar tra il 2017 e il 2025 (sia uomini sia donne).
import pandas as pd
